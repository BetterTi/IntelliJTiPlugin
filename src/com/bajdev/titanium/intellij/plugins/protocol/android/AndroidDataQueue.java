...
import com.bajdev.titanium.intellij.plugins.protocol.AndroidDebugCommands;
import com.bajdev.titanium.intellij.plugins.protocol.AndroidSubmittedRequest;
...
public class AndroidDataQueue {
	...
	private static final Logger Log = Logger.getInstance(AndroidDataQueue.class.getName());
